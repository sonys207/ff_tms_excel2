...
$router->get('/xlsgenerate1','Controller@xlsgenerate1');
$router->get('/xlsgenerate2','Controller@xlsgenerate2');
$router->get('/xlsfulfillmentorderlist','Controller@xlsfulfillmentorderlist');
$router->get('/sendemail','Controller@sendemail');
$router->get('/excelandemail','Controller@excelandemail');
